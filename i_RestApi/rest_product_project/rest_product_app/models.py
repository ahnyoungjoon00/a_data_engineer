...
class Category(models.Model):
    ctgno = models.CharField(db_column='ctgNo', primary_key=True, max_length=10)  # Field name made lowercase.
    ctgname = models.CharField(db_column='ctgName', max_length=300, blank=True, null=True)  # Field name made lowercase.
